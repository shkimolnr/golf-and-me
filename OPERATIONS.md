...
3. Supabase 진단의 `202608310002_app_diagnostics.sql`은 2026-08-31 Production에 적용했고 `app_diagnostics` 테이블 생성을 확인했습니다. Vercel에는 `SUPABASE_SERVICE_ROLE_KEY`만 Secret으로 등록하며, `VITE_` 접두사나 브라우저 번들에 절대 포함하지 않습니다.
